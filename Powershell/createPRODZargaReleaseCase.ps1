...
$CaseBody = "{
  ...
  `"Subject`": `"$subject`",
  `"TestedChange`": `"Yes`",
  `"VerificationPlan`": `"Validate that all endpoints return a result.`",
  `"WorkItemNumber`": `"`",
  `"ImplementationSteps`": [   
                                {
                                  ...
                                  `"ListOfImplementationSteps`": [`"Deploy the latest build of Zarga to the following servers:`",`" `",`"IND1CS0DBAAPI01 - 172.20.28.230`",`"IND1CS0DBAAPI02 - 172.20.28.231`"]
                                }
                           ]
}"
