PARAM(
    ...
    #  .\createStandby-CR.ps1 -targetDB 'configDB' -targetProd 'IND1P01C092I04\I04' -targetStandby 'IND1P01CB092I04\I04' -workItem '' -dataCenter 'IND1' -changeType 'Emergency Break-Fix' -startDateTime '7/11/2019 4PM' -dryRun 0 -verbose
    #  .\createStandby-CR.ps1 -targetDB 'configDB' -targetProd 'IND1P01C092I04\I04' -targetStandby 'IND1P01CB092I04\I04' -workItem '' -dataCenter 'IND1' -startDateTime '7/11/2019 4PM' -dryRun 0 -verbose
