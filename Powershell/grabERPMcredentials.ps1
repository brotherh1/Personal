 Function Get-ErpmSharedPassword
        {
            ...
            param(  [Parameter(Mandatory=$true)] [string]$AccountName,
                    ...
                    [Parameter(Mandatory=$true)] [ValidateSet("QA","CT","XT")] [string]$Environment,
...
# visually inspect password is correct uncomment next line.
# $outputAccount.Password
## User passwrod for good only.....
